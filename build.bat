...
python scripts\custom_pack.py main.py -y --name "AnyConverterApp" --icon assets\icon.ico --add-data "assets;assets" --add-data "bin;bin" --distpath "dist" --product-name "Any Converter" --file-description "Any Converter" --product-version "1.2.1.0" --file-version "1.2.1.0" --company-name "SwiftGrab" --copyright "Copyright (c) 2026 SwiftGrab"
